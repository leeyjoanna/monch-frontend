...
const Save = ({list, pageURL}) => {
    ...
    if (list.length > 0){
        ...
        return (
            ...
            return (
                <div>
                    <div className ='search-div'>Name your list: <input type='text' id='title-name' autoComplete='off'></input></div>
                    <div className='search-div'>Date of event: <input type='date' id='event-date' acutcomplete='off'></input></div>
